                ...
                >
                  ...
                  <TableCell>
                    <div className="grid w-fit grid-cols-4 gap-x-2 text-xs tabular-nums text-muted-foreground">
                      <span className="inline-flex items-center gap-1" title="Views"><Eye className="size-3.5" />{formatAuditViewCount(a.views, a.viewCountCapped, a.viewCountPending)}</span>
