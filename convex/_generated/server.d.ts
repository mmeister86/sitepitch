...
type Env = {
  ...
  readonly EVE_EVALS_ENABLED: string | undefined;
  readonly EVE_EVAL_REPORTER_SECRET: string | undefined;
  readonly EVE_RUNTIME_ENABLED: string | undefined;
  readonly EVE_RUNTIME_SERVICE_PASSWORD: string | undefined;
  readonly EVE_RUNTIME_SERVICE_USERNAME: string | undefined;
  readonly EVE_RUNTIME_URL: string | undefined;
  readonly FIRECRAWL_API_BASE_URL: string | undefined;
  readonly FIRECRAWL_API_KEY: string | undefined;
  readonly GOOGLE_GMAIL_CLIENT_ID: string | undefined;
  readonly GOOGLE_GMAIL_CLIENT_SECRET: string | undefined;
  readonly GOOGLE_PLACES_API_KEY: string | undefined;
  readonly GOOGLE_SHEETS_CLIENT_ID: string | undefined;
  readonly GOOGLE_SHEETS_CLIENT_SECRET: string | undefined;
  readonly HUBSPOT_CLIENT_ID: string | undefined;
  readonly HUBSPOT_CLIENT_SECRET: string | undefined;
  readonly INTEGRATIONS_DISABLED_PROVIDERS: string | undefined;
  readonly INTEGRATIONS_ENABLED: string | undefined;
  readonly INTEGRATION_CREDENTIAL_KEYRING: string | undefined;
  readonly INTEGRATION_OAUTH_REDIRECT_URL: string | undefined;
  ...
  readonly PIPEDRIVE_CLIENT_ID: string | undefined;
  readonly PIPEDRIVE_CLIENT_SECRET: string | undefined;
  ...
  readonly PUBLIC_API_ENABLED: string | undefined;
